			...
			<div class="row s_product_inner">
					...
					<div class="s_product_img">
							...
							<div class="carousel-inner">
								<div class="carousel-item active">
									<img class="d-block w-100" src="<?= base_url('assets/img/product/').$keranjang1['foto']; ?>" height="500px">
								</div>
						</div>
					</div>
				</div>
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<h2><?=$this->sepeda_models->rupiah($keranjang1['harga']); ?></h2>
						<ul class="list">
							<li>
								<a class="active" href="#">
							...
							<form action="<?= base_url('sepeda/editkeranjang1') ;?>" method="POST">
							<li>
								<div class="product_count">
							<label for="qty">Jumlah:</label>
							<input type="text" name="qty" id="sst" maxlength="12" value="<?=$keranjang1['jumlah']; ?>" title="Quantity:" class="input-text qty">
						...
						<input type="text" name="" value="<?=$keranjang1['qty'] ;?>">
							</li>
