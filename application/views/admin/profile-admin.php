	...
	<section class="checkout_area">
		...
		<div class="billing_details">
			<div class="row">
				<div class="col-lg-8">
					<h3><br>Detail Profil</h3>
					<form class="row contact_form" action="<?= base_url('admin/ubah_profile'); ?>" method="post" enctype="multipart/form-data">
						...
						<div class="col-md-12 form-group">
							<span>No Hp</span>
							<input type="text" class="form-control" id="nohp" name="nohp" placeholder="Belum di atur"  value="<?=($user['nohp']); ?>">
						</div>
						<div class="col-md-12 form-group">
							<span>Email</span>
							<input type="email" class="form-control" id="email" name="email" placeholder="Belum di atur" value="<?= $user['email']; ?>">
						</div>
						<div class="col-md-12 form-group p_star">
							<span>Alamat</span>
							<textarea class="form-control" name="alamat" id="alamat" rows="0" placeholder="Belum diatur"><?= $user['alamat']; ?></textarea>
						</div>
						...
						<div class="col-md-5 form-group p_star">
							<a  class="btn btn-primary" data-toggle="modal" data-target="#ubahrekening" id="btn-tambahUlasan" href="">Ubah No rekening</a>
						</div>
					</div>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn gray_btn" data-dismiss="modal">Batal</button>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body ">
					No Rekening
					<div class="input-group mb-3">
						<input type="number text" name="norekening" class="form-control" placeholder="No Rekening" aria-label="Username" aria-describedby="basic-addon1" required>
					</div>
					Atas Nama
					<div class="input-group mb-3">
