...
class Auth extends CI_Controller {
	...
	public function register(){
		...
		$this->form_validation->set_rules('username','Username','required|trim|is_unique[tb_user.username]',['required'=>'Username belum diisi!','is_unique'=>'Username ini sudah digunakan']);
